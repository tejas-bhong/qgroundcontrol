...
void StandardModes::gotMessage(MAV_RESULT result, const mavlink_message_t &message)
{
    ...
    if (result == MAV_RESULT_ACCEPTED) {
        ...
        bool cannotBeSet = availableModes.properties & MAV_STANDARD_MODE_PROPERTY_CANNOT_BE_SET;
        bool advanced = availableModes.properties & MAV_STANDARD_MODE_PROPERTY_ADVANCED;
